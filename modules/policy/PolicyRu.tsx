...
const PolicyRu: FC = () => {
  return (
    <div className={`${styles.policy_container} ${styles.policy_ru}`}>
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые Conquest of Infinity
        (далее — Оператор).
      </p>
      <ul>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          сети интернет по сетевому адресу https://vsemsport.online.
        </li>
        <li>
      ...
      <p>Персональные данные фамилия, имя, отчество, электронный адрес</p>
      <p>Правовые основания 152-ФЗ</p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          sl163@ya.ru с пометкой «Актуализация персональных данных».
        </li>
        <li>
          ...
          на электронный адрес Оператора sl163@ya.ru с пометкой «Отзыв согласия
      ...
      <ul>
        <li>
          ...
          Оператору с помощью электронной почты sl163@ya.ru.
        </li>
        <li>
        ...
        <li>
          ...
          сети Интернет по адресу https://vsemsport.online/policy/ru.
        </li>
      </ul>
    </div>
  );
