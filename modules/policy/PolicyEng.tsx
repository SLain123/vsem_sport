...
const PolicyEng: FC = () => {
  return (
    <div className={styles.policy_container}>
      <h1>Privacy Policy for Conquest of Infinity</h1>
      <p>
        At vsem sport online, accessible from https://vsemsport.online/, one of
        ...
        vsem sport online and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in vsem sport online. This policy is not
      ...
      <h2>Log Files</h2>
      <p>
        vsem sport online follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of vsem sport online.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on vsem sport online, which are
      ...
      <p>
        Note that vsem sport online has no access to or control over these
        cookies that are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        vsem sport online's Privacy Policy does not apply to other advertisers
      ...
      <p>
        vsem sport online does not knowingly collect any Personal Identifiable
